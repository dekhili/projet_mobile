...
public class EvaluationService {
  ...
  //  Events evnt = new Events();
    ...
    public boolean addEvaluation(Evaluations r , int event_id) {
      //  String url = Statics.BASE_URL + "/ajouter/" + r.getEvent_id() + "/" + r.getQuantite() +r.getPrixpaye(); //création de l'URL
        req.setUrl("http://localhost/projet_pidev/symfony/web/app_dev.php/event/evaluation/ajouter/" + event_id+"/?note="+r.getNote()+"&commentaire=" +r.getCommentaire());// Insertion de l'URL de notre demande de connexion
       ...
       public Evaluations getEv2(int evaluation_id) {
        ...
        req.setUrl("http://localhost/projet_pidev/symfony/web/app_dev.php/event/evaluation/details/" +evaluation_id);
         req.setPost(false);
