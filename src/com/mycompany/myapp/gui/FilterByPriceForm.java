...
public class FilterByPriceForm extends HomeForm {

      Form current;
   
    public FilterByPriceForm(Form previous,String i , String j) {
        current = this;
 
        current.setTitle("Filter Products By Price");
        ...
        Toolbar tb = current.getToolbar();
          ...
          current.getToolbar().addCommandToLeftBar("back", null, (ev) -> {
                SortListProdForm hf = new SortListProdForm();
                hf.getF().show();
        ...
        for (Product p : searchProdService.getInstance().getProdsByPrice(i,j)) {
