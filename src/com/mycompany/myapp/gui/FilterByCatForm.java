...
public class FilterByCatForm extends HomeForm {
     Form current;
    
    public FilterByCatForm(Form previous,String i)  {
        current = this;
 
        current.setTitle("Products : "+i);
        ...
        Toolbar tb = current.getToolbar();
          ...
          current.getToolbar().addCommandToLeftBar("back", null, (ev) -> {
                HomeForm hf = new ListCategoryForm();
                hf.getF().show();
        ...
        for (Product p : searchProdService.getInstance().getProdsByCat(i)) {
